...
export default function SocialShareButtons({ title, description, slug }: SocialShareButtonsProps) {
  const [isOpen, setIsOpen] = useState(false);
  const [copied, setCopied] = useState(false);

  const url = `${window.location.origin}/artikel-kesehatan/${slug}`;
  ...
  return (
    <div className="relative">
      ...
      {isOpen && (
        <div className="absolute top-full right-0 sm:right-0 sm:left-auto left-1/2 sm:transform-none -translate-x-1/2 mt-2 w-72 bg-white rounded-xl shadow-xl border border-gray-200 z-50">
          <div className="p-4">
