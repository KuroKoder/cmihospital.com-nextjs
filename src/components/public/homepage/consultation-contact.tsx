...
import SpecialistModal from "../../ui/consultation-home";
import {
  Pill,
  HeartPulse,
  Syringe,
...
const ConsultationPage: React.FC = () => {
  const [selectedSpecialist, setSelectedSpecialist] =
    useState<ConsultationSpecialist | null>(null);
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-green-50/30">
      {/* Hero Section */}
      <section className="relative overflow-hidden bg-gradient-to-br from-green-500 via-green-600 to-emerald-700 min-h-[70vh] flex items-center pt-28">
        ...
        <div className="relative container mx-auto px-6 py-20">
          <div className="max-w-5xl mx-auto text-center">
            ...
            <p className="text-xl md:text-2xl text-green-50/90 mb-12 leading-relaxed max-w-4xl mx-auto font-light">
              Dapatkan informasi dan konsultasi kesehatan terpercaya dari tim
              ahli medis bersertifikat untuk berbagai penyakit kronis
            </p>
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="text-center mb-20">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
              Tim spesialis kami memberikan informasi medis terpercaya dan
